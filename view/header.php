    ...
    <nav class="blue darken-2 fadeInDown">
        <div class="nav-wrapper">
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                <?php echo (isset($_SESSION["admin"])) ? '<li class="nav-content"><a href="admin.php"><span class="material-icons" style="font-size:14px;">build</span> Admin View</a></li>' : '<li class="nav-content"><button class="btn blue darken-4"><span class="material-icons" style="font-size:14px;">directions_run</span> Log out</button></li>' ?>
            </ul>
            <ul id="nav-mobile" class="hide-on-large-only">
                ...
                <div class="right">
                    <?php echo (isset($_SESSION["admin"])) ? '<li class="nav-content"><a href="admin.php"><span class="material-icons" style="font-size:14px;">build</span> Admin View</a></li>' : '<li class="nav-content"><button><span class="material-icons" style="font-size:14px;">directions_run</span> Log out</button></li>' ?>
                </div>
            </ul>
        </div>
    </nav>